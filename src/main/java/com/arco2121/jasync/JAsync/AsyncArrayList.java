...
import com.arco2121.jasync.AsyncTypes.AsyncCollection;
...
public class AsyncArrayList extends AbstractList<Object> implements RandomAccess, Serializable, Cloneable, AsyncCollection {
    ...
    @Override
    public Object clone() {
        AsyncArrayList copy = new AsyncArrayList();
